# pagila-hw
[![](https://github.com/Mateenmok/pagila-hw/actions/workflows/tests.yml/badge.svg)](https://github.com/Mateenmok/pagila-hw/actions?query=workflow%3Atests)
...
1. Fork this repo and clone it on the lambda server.
    ...
    ```
    $ git clone https://github.com/Mateenmok/pagila-hw
    $ cd pagila-hw
    $ git submodule init
